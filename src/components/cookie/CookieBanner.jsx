...
function CookieBanner() {
  ...
  return (
    <>
      {visible && (
        <div className="z-[1000] fixed bottom-0 left-0 right-0 p-4 sm:p-6 text-[#BDA47A] text-sm sm:text-base bg-[rgba(255,255,255,0.06)] backdrop-blur-[16px] border-t border-white/20 shadow-[0_-4px_12px_rgba(0,0,0,0.25)]">
