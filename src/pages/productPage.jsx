        ...
        <div
          className={
            isDesktop
              ...
              : "w-full mx-auto flex flex-col items-center px-4 overflow-hidden pt-4 pb-4 min-h-[calc(100vh-120px)]"
          }
        >
          {/* Изображение */}
          <div
            className={
              isDesktop
                ...
                : "relative w-full h-[40vh] sm:h-[42vh] max-w-full rounded-2xl overflow-hidden shadow-xl"
            }
          >
            <img
          ...
          {/* Контент */}
          <div className={isDesktop ? "flex-1 min-w-[360px] max-w-[560px] h-[560px] flex flex-col justify-between overflow-hidden gap-4" : "w-full flex flex-col items-center text-center flex-1 min-h-0 overflow-hidden relative lg:h-auto lg:overflow-visible max-h-[calc(55vh-16px)]"}>
            <div
                      ...
                      {tab === "desc" ? (
                        <>
                          <div
                            ...
                            className="flex-1 overflow-y-auto overscroll-contain scrollbar-none px-4 pt-2 pb-14 text-xs md:text-sm text-center md:text-left whitespace-pre-line text-[#5C3A2E]"
                          >
